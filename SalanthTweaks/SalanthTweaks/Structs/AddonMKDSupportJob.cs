...
public unsafe struct AddonMKDSupportJob
{
    ...
    [FieldOffset(0x2f0)] internal FixedSizeArray4<Row> _rows;

    [System.Diagnostics.CodeAnalysis.UnscopedRefAttribute] public Span<Row> Rows => _rows;


    [StructLayout(LayoutKind.Explicit, Size = 0x238)]
    public struct Row
    {
        [FieldOffset(0x0)] internal FixedSizeArray7<MKDSupportJobNodePtrs> _jobs;
        [System.Diagnostics.CodeAnalysis.UnscopedRefAttribute] public Span<MKDSupportJobNodePtrs> Jobs => _jobs;

        [FieldOffset(0x230)] public byte numJobs;
    }

    [StructLayout(LayoutKind.Explicit, Size = 0x50)]
    public struct MKDSupportJobNodePtrs
    {
        [FieldOffset(0)] public AtkComponentButton* Button;

        [FieldOffset(0x8)] internal FixedSizeArray8<Pointer<AtkResNode>> _nodes;
        [System.Diagnostics.CodeAnalysis.UnscopedRefAttribute] public Span<Pointer<AtkResNode>> Nodes => _nodes;

        [FieldOffset(0x48)] public byte JobId;
    }
}
